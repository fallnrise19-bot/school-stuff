...
- Android versionCode: 22 so this APK installs over later test builds without uninstalling or clearing local app data
- Display version: `0.1.6-compact-settings`
